<html>
   <head>
      <title>Print Ticket || Pravasan</title>
...
<div class="container" ng-controller="search">
            ...
            <form id="myForm" method="post" data-parsley-validate="" autocomplete="off" >
                  <section id="Search" class="LB XXCN  P20">
                     <h1 class="bookTic XCN TextSemiBold" ><center><b>Ticket Print</b></center></h1>
                     ...
                     <br>
                     <button class="LB Xbutton" id="cancelPnr">Print Ticket</button>
                  </section>
              </form>
